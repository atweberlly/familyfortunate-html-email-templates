    ...
    <Html lang="en">
      ...
      <body style={base}>
        <Section style={container}>
          ...
          <Text style={text.base}>Your password has been successfully updated.</Text>

          <Text style={text.base}>
            If you did not perform this action, you should go to this{' '}
            <a href="/forgot-password" style={link}>
              link
            </a>{' '}
